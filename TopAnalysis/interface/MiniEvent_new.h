#ifndef _minievent_new_h_
#define _minievent_new_h_

#include "TTree.h"

struct MiniEvent_t_new
{
MiniEvent_t_new(): met_pt(met_pt_read[0]), met_phi(met_phi_read[0]), met_sig(met_sig_read[0])
  {
  ...
  Float_t            l_scaleUnc1[50], l_scaleUnc2[50], l_scaleUnc3[50], l_scaleUnc4[50], l_scaleUnc5[50], l_scaleUnc6[50], l_scaleUnc7[50];
  Float_t            l_miniIso[50], l_chargedHadronIso[50], l_relIso[50], l_ip3d[50], l_ip3dsig[50], l_mva[50];
  Float_t            l_highpt[50];
  Float_t            l_mvaCats[50];
  ...
  //Float_t          j_jecUp[30][200], j_jecDn[30][200];
  Float_t            j_csv[200], j_deepcsv[200];
  Float_t            j_pumva[200], j_emf[200];
  Float_t            j_qg[200];
  ...
  Bool_t             j_btag[200];
  Int_t              j_vtxNtracks[200], j_flav[200];
  Int_t              j_id[200];
  Int_t              j_pid[200], j_hadflav[200], j_g[200];

  //met
  Int_t              nmet;
  Float_t            met_pt_read[2], met_phi_read[2], met_sig_read[2]; 
...
void createMiniEventTree(TTree * t, MiniEvent_t_new & ev, Int_t njecUncs = 0);
void attachToMiniEventTree(TTree * t, MiniEvent_t_new & ev, bool full = false);

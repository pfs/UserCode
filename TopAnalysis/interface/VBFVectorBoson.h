...
private:
  ...
  float vbfmva_,flat_vbfmva_, vbfmvaHighVPt_ ,vbfmvaLoos_,flat_vbfmvaLoos_,vbfmva0_,flat0_vbfmva_, vbfmvaHighVPt0_ ,vbfmva1_,flat1_vbfmva_, vbfmvaHighVPt1_, vbfmva2_,flat2_vbfmva_, vbfmvaHighVPt2_  ;
  float evtWeight_;

...
void createMiniEventTree(TTree *tree, MiniEvent_t_new & ev, Int_t njecUncs)
{
  //event header
...
//
void attachToMiniEventTree(TTree * tree, MiniEvent_t_new & ev, bool full)
{
  //event header

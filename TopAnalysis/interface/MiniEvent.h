...
struct MiniEvent_t
{
  ...
  Float_t j_vtxmass[200],j_vtxchi2[200],j_vtx3DVal[200],j_vtx3DSig[200],j_vtxpx[200],j_vtxpy[200],j_vtxpz[200];
  Bool_t j_btag[200];
...
void attachToMiniEventTree(TTree *t, MiniEvent_t &ev, bool full = false, bool hasCTPPS = true);
